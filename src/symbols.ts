...
export const parserSymbol = Symbol.for('@kuankuan/k-markdown-vue#parserSymbol') as InjectionKey<ComputedRef<KMarkdownParser>>;
export const optionSymbol = Symbol.for('@kuankuan/k-markdown-vue#optionSymbol') as InjectionKey<ComputedRef<KMarkdownVueOptions>>;
